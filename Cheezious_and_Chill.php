...
<body>
    ...
    <div class="container-fluid p-5">
        <h1 class="pt-5">Cheezious and Chill: The Perfect Movie Night Pairings</h1>
        ...
        <div class="row">
            <div class="col-lg-9 col-sm-12 d-block mx-auto pt-4">
                <img width="100%" src="https://cz-content-prod.s3.me-south-1.amazonaws.com/cheeziuos-cms/large_img1_7bd2300457.webp" alt="">

                <h5 class="fw-bold py-3 pt-5 py-2">Cheezious and Chill: The Perfect Movie Night Pairings</h5>
